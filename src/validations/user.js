...
const validateRegister = (req, res, next) => {
  ...
  if (!name) {
    return errorResponse({
      res,
      statusCode: StatusCodes.BAD_REQUEST,
      message: MSG.REQUEST.MISSING_NAME,
    });
  }
  if (!email) {
    return errorResponse({
      res,
      statusCode: StatusCodes.BAD_REQUEST,
      message: MSG.REQUEST.MISSING_EMAIL,
    });
  }
  if (!phone_no) {
    return errorResponse({
      res,
      statusCode: StatusCodes.BAD_REQUEST,
      message: MSG.REQUEST.MISSING_PHONE,
    });
  }
  if (!password) {
    return errorResponse({
  ...
  if (!user_name) {
    return errorResponse({
      res,
      statusCode: StatusCodes.BAD_REQUEST,
      message: MSG.REQUEST.MISSING_USERNAME,
    });
  }
  if (!gender) {
    return errorResponse({
      res,
      statusCode: StatusCodes.BAD_REQUEST,
      message: MSG.REQUEST.MISSING_GENDER,
    });
  }
